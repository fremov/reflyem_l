    ...
    <div class="row">
        <div class="col-5 col-sm-3">
            <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link" id="vert-tabs-settings-tab" data-toggle="pill" href="#vert-tabs-settings" role="tab" aria-controls="vert-tabs-settings" aria-selected="false">Список изменений</a>
            </div>
        </div>
        <div class="col-7 col-sm-9">
            <div class="tab-content" id="vert-tabs-tabContent">
                ...
                <div class="tab-pane fade" id="vert-tabs-settings" role="tabpanel" aria-labelledby="vert-tabs-settings-tab">
                        <table class="table table-bordered border border-5 border-dark text-dark fs-5">
                            <tbody>
                            @foreach ($changelog as $index => $item)
                                <tr>
                                <td class="border-bottom border-3 border-dark fw-bolder">{{ $loop->iteration }}</td>
                                <td class="border-bottom border-3 border-dark fw-bolder">{{ $item['Unnamed: 1'] }}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
