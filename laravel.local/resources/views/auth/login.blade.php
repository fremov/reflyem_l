                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="mb-3 col-md-4 col-form-label text-md-right">{{ ('E-Mail') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="mb-3 col-md-4 col-form-label text-md-right">{{ __('Пароль') }}</label>
